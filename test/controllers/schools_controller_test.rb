...
class SchoolsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create school" do
    assert_difference('School.count') do
      post schools_url, params: { school: { name: @school.name, number: @school.number, place: @school.place } }
    end
  ...
  test "should update school" do
    patch school_url(@school), params: { school: { name: @school.name, number: @school.number, place: @school.place } }
